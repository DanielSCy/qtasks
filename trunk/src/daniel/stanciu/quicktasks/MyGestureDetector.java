...
public class MyGestureDetector {
     ...
     */
    @Deprecated
    public MyGestureDetector(OnGestureListener listener, Handler handler) {
...
//    	Log.d("MyGestureDetector", "onTouchEvent enter: " + ev.getActionMasked());
//    	for (StackTraceElement elem : Thread.currentThread().getStackTrace()) {
//    		Log.d("MyGestureDetector", Thread.currentThread().getId() + elem.toString());
//    	}
        ...
        case MotionEvent.ACTION_DOWN:
            if (mDoubleTapListener != null) {
                ...
                if ((mCurrentDownEvent != null) && (mPreviousUpEvent != null) && hadTapMessage &&
                    ...
                    // remove the LONG_PRESS message
//                    Log.d(QuickTasksActivity.TAG, "Removing LONG_PRESS message on double tap");
            ...
            if (mIsLongpressEnabled && !mIsDoubleTapping) {
                mHandler.removeMessages(LONG_PRESS);
//                Log.d(QuickTasksActivity.TAG, "sending LONG_PRESS message");
...
//    	Log.d("MyGestureDetector", "onTouchEvent exit");
        return handled;
    }
    ...
    private void dispatchLongPress() {
        mHandler.removeMessages(TAP);
//        Log.d(QuickTasksActivity.TAG, "Dispatching LONG_PRESS");
        mInLongPress = true;
